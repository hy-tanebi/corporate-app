                        ...
                        "@graph": [
                            {
                                ...
                                "description": "タネビ クリエイティブ（TANEBI CREATIVE）は、AIO（AI検索最適化）を導入したWeb制作と、LLMO（AI推奨最適化）を駆使したDX改善サポートを提供する、岩手県奥州市の個人事務所です。発芽するアイデアを形にし、種火のように根幹から寄り添う支援。技術と対話で事業の前進を支援します。",
                            ...
                            },
                            {
                                ...
                                "description": "AI検索（AIO）に最適化された高品質なWebサイト制作。人間への訴求力とAIへの可読性を両立します。",
                                "areaServed": {
                                    "@type": "AdministrativeArea",
                                    "name": "岩手県"
                                }
                            },
                            {
                                ...
                                "description": "AI推奨（LLMO）を考慮した業務効率化・DX推進サポート。社内ナレッジの整理と活用を支援します。",
                                "areaServed": {
                                    "@type": "AdministrativeArea",
                                    "name": "岩手県"
                                }
