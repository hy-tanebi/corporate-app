...
企画・デザイン・実装・運用をすべて1人で担当しました。単なる技術の組み合わせではなく、**ブランドコンセプトから逆算した技術選定**と、**1人開発でも品質を維持するためのワークフロー設計**を意識しています。

採用担当の方へ：技術スタックや実装の詳細だけでなく、「なぜその技術・デザインを選んだか」という判断の背景も記述しています。コードと設計の両面からご覧いただけますと幸いです。
